        ...
        <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
          ...
          You can check the /login route to see what happens next. -->
            <form  method="post" action="/login">
              ...
              <input class="form-control form-control-lg my-1" type="phone" name="Phone" placeholder="Phone Number" required>
              ...
              <p class="text-muted text-center">Need an Account? <a href="/register">Register Here</a>.</p>
            </form>
        </div>
    </div>
</main>
